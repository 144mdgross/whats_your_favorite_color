...
# This was the second index rendering before the 'render' shortcut above
# def index(request):
#     latest_question_list = Question.objects.order_by('-pub_date')[:5]
...
# This was the first index render that only displays text.
# def index(request):
...
# This is the long way using Http404
# def detail(request, question_id):
#     try:
...
# This is the shortcut for the abouve method
# def detail(request, question_id):
